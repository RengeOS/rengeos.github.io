...
<LinkCard title="Installation instructions" href="/installation/minimal-iso-installation/#choose-a-hard-drive-to-install-on" />
...
<LinkCard title="NiriWM Edition Configuration" href="/configuration/niriwm-edition" />
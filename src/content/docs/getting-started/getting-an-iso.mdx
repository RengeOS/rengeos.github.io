...
<CardGrid>
  ...
  <Card title="Github Release (Latest)" icon="cloud-download">
    ...
    How to combine ISO: <a href="/getting-started/getting-an-iso/#download-from-github-and-combine-each-iso-part" rel="noopener noreferrer">Instruction</a>
  </Card>
</CardGrid>
...
<LinkCard title="Create Bootable USB" href="/getting-started/create-bootable-usb/" />
